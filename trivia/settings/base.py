...
def get_env_var(name, default=None):
    ...
    Keyword Argument:
        name -- The environment variables name.
        default -- The default if the environment name cannot be fetched.
    Returns:
        os environment variable value
    Raises:
        ImproperlyConfigured exception, if unable to get the default.
    """
    try:
